public class Platter implements SimProcess {
    ...
    @Override
    public void commit() { tickCounter = nextTickCounter; if (tickCounter % 1000 == 0) System.out.println("[Platter] Tick: " + tickCounter); }
    @Override
