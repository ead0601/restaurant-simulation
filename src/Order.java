public class Order implements SimProcess {
    ...
    @Override
    public void commit() { tickCounter = nextTickCounter; if (tickCounter % 1000 == 0) System.out.println("[Order] Tick: " + tickCounter); }
    @Override
